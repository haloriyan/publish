import { IconArrowRight, IconArrowRightCircle, IconBox, IconBuildingStore, IconCategory, IconEye, IconFlame, IconLivePhoto, IconLiveView, IconPlayerSkipForward, IconShoppingBag, IconSignRight } from "@tabler/icons-react";
import { Substring } from "../../lib";
import config from "../../config";

const PopularLive = ({streamDatas}) => {
    return (
        <>
            <div className="flex items-center gap-4">
                <IconLivePhoto color={config.primaryColor} size={28} />
                <div className="text-slate-700 text-lg font-medium flex grow">Live Streaming Populer</div>
